...
public struct HSBColor
{
    ...
    public static void Test()
    {
        ...
        _Debug.log("red: " + color);
        
        color = new HSBColor(Color.green);
        _Debug.log("green: " + color);
        
        color = new HSBColor(Color.blue);
        _Debug.log("blue: " + color);
        
        color = new HSBColor(Color.grey);
        _Debug.log("grey: " + color);
        
        color = new HSBColor(Color.white);
        _Debug.log("white: " + color);
        
        color = new HSBColor(new Color(0.4f, 1f, 0.84f, 1f));
        _Debug.log("0.4, 1f, 0.84: " + color);
        
        _Debug.log("164,82,84   .... 0.643137f, 0.321568f, 0.329411f  :" + ToColor(new HSBColor(new Color(0.643137f, 0.321568f, 0.329411f))));
    }
}