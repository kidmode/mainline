...
public class ControlSubjectState : GameState
{
	...
	private void onHelpButtonClick(UIButton p_button)
	{
		...
		l_titleLabel.text = "Promote Subjects";
		l_contentLabel.text = "Promote the subjects that matter most. Our Recommender technology will seamlessly push more of the content you promote to Kid Mode.";
