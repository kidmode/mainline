...
public class CreateAccountUpSellState : GameState 
{
	...
	public override void enter(GameController p_gameController)
	{
		...
		SwrveComponent.Instance.SDK.NamedEvent("tutorial.GET_PREMIUM_UI");
	}
	...
	{
		SwrveComponent.Instance.SDK.NamedEvent("tutorial.NO_THANKS_IN_PREMIUM_UI");
	...
	private void goBack(UIButton p_button)
	{
		...
		SwrveComponent.Instance.SDK.NamedEvent("tutorial.BACK_FROM_PREMIUM_UI");
	}

	private void startFreeTrial(UIButton p_button)
	{
		m_subState = SubState.GO_TRIAL;
		SwrveComponent.Instance.SDK.NamedEvent("tutorial.START_TRIAL");
	}
